...
my $vsx_dir = "visualc/VS2012";
my $vsx_ext = "vcxproj";
my $vsx_app_tpl_file = "scripts/data_files/vs2012-app-template.$vsx_ext";
my $vsx_main_tpl_file = "scripts/data_files/vs2012-main-template.$vsx_ext";
my $vsx_main_file = "$vsx_dir/mbedTLS.$vsx_ext";
my $vsx_sln_tpl_file = "scripts/data_files/vs2012-sln-template.sln";
...
my $vsx_sln_conf_entry_tpl = <<EOT;
		...
		{GUID}.DebugSRT|Win32.ActiveCfg = DebugSRT|Win32
		{GUID}.DebugSRT|Win32.Build.0 = DebugSRT|Win32
		{GUID}.DebugSRT|x64.ActiveCfg = DebugSRT|x64
		{GUID}.DebugSRT|x64.Build.0 = DebugSRT|x64
		{GUID}.ReleaseSRT|Win32.ActiveCfg = ReleaseSRT|Win32
		{GUID}.ReleaseSRT|Win32.Build.0 = ReleaseSRT|Win32
		{GUID}.ReleaseSRT|x64.ActiveCfg = ReleaseSRT|x64
		{GUID}.ReleaseSRT|x64.Build.0 = ReleaseSRT|x64
EOT
